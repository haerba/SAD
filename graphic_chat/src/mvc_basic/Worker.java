...
public class Worker implements Runnable, ListDataListener{
    ...
    private DataOutputStream dataOutput;
     ...
     // Es crea una instància d'aquesta conversació i un listener pels canvis d'aquesta. 
    ...
    // Fil encarregat d'atendre el socket. Tot el que li arribi, serà afegit a la conversació
    public void run(){
        try
        {
            while (true)
    ...
    // Envia el ultim text de la conversació pel socket, aquest métode és avisat cada vegada que
    // s'afegeix alguna cosa a la conversació, d'aquesta manera el que escrigui un client, serà reenviat
